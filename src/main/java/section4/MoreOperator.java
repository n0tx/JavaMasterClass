...
public class MoreOperator {
    public static void main(String[] args) {
        ...
        double firstNumDouble = 20d;
        // 2. Create a second variable of type double with the value 80
        double secondNumDouble = 80d;
        // 3. Add both numbers up and multiply by 25
        double resultDouble = (firstNumDouble + secondNumDouble) * 25d;
        System.out.println("resultDouble: " + resultDouble);
        // 4. Use the remainder operator to figure out the remainder from the sum of #3 divided by 40
        double totalRemaining = (resultDouble % 40);
        System.out.println("totalRemaining: " + totalRemaining);
        // 5. Write an "if" statement that displays a message "Total was over the limit"
        if (totalRemaining <= 20) {
            System.out.println("totalRemaining : " + totalRemaining + ", equal to 20 or less.");
        }
